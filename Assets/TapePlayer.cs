...
public class TapePlayer : Interactable
{
    ...
    void Start()
    {
        ...
        {
            clockController = GameObject.FindObjectOfType<ClockController>();
        }

        if (roomStateManager == null)
        {
            roomStateManager = GameObject.FindObjectOfType<RoomStateManager>();
        }
    ...
    private void EnsureUI()
    {
        if (captionUI == null)
        {
            captionUI = GameObject.FindObjectOfType<TextMeshProUGUI>();
        }
    }
    ...
    public override void Interact()
    {
        ...
        if (!PlayerController.hasTape)
        {
            ...
            warningCoroutine = StartCoroutine(ShowWarningRoutine(warningCaption));
            return;
        }
    ...
    IEnumerator PlayTapeSequence(AudioClip clip, string scriptText, float displayTime, int tapeNumber)
    {
        ...
        if (captionUI != null)
        {
            ...
            foreach (string line in lines)
            {
                ...
                // Step 1: The Catalyst - Check if line is "Your time is officially up."
        ...
        if (tapeNumber == 1)
        {
            ...
            Debug.Log("TapePlayer: Tape 1 done. Waiting for player to find Tape 2.");
            if (GameManager.instance != null)
            {
                GameManager.instance.SetObjective("Find and pick up Tape 2.");
            }
        }
