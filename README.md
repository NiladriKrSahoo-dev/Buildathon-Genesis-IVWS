...
graph TD
    ...
    B --> C["<b>Scene 3: The Search for Escape</b><br/>• Objective: Search the room for Tape 2<br/>• Investigate hidden corners of the room<br/>• Retrieve Tape 2: 'VHSTape_WifeLore'"]
